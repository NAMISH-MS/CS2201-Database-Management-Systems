...
/*'root@localhost', 'LAPTOP-BMPMMU9A', '8.0.42', '2025-09-29 11:32:53'
*/
-- ----------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------------
-- Question 02: Find the average salary for each job_id. Display the job_id and the average salaryQuestion.
-- Write the SQL Statement for the above Question
...
max(salary) AS max_salary, min(salary) AS min_salary, avg(salary) AS avg_salary
From employees
Group BY department_id
